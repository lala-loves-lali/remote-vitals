...
/**
 * Controller for the doctor view of a patient's vitals visualization.
 * Displays graphs of patient vital data over time.
 */
public class DoctorViewVitalsController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        System.out.println("********************************************");
        System.out.println("DoctorViewVitalsController: initialize() started");
        System.out.println("********************************************");

        try {
            // Get selected patient from the patients controller
            currentPatient = DoctorPatientsController.getSelectedPatient();
            ...
            if (currentPatient == null) {
                ...
                showErrorAlert("Error", "Patient Error", "No patient selected. Please select a patient first.");
                return;
            }
            ...
            System.out.println("********************************************");
            System.out.println("DoctorViewVitalsController initialization complete");
            System.out.println("********************************************");
        } catch (Exception e) {
            System.out.println("********************************************");
    ...
    private void configureChart() {
        ...
        vitalsChart.setTitle("Patient Vital Signs Over Time");
     ...
     * Navigates back to the doctor's patients page.
     * 
     * @param event The action event
     */
    @FXML
